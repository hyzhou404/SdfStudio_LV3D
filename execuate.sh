...
## Nefacto Train
python scripts\train.py nerfacto --pipeline.model.collider-params near_plane 0.0 far_plane 6.0 --pipeline.datamanager.camera-optimizer.mode off --vis tensorboard --data datasets/kitti360_nerfacto

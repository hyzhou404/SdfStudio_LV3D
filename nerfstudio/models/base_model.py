...
class Model(nn.Module):
    ...
    @abstractmethod
    def get_outputs(self, ray_bundle: RayBundle, lidar_rays=None, sky_mask=None) -> Dict[str, torch.Tensor]:
    ...
    def forward(self, ray_bundle: RayBundle, lidar_rays=None, sky_mask=None) -> Dict[str, torch.Tensor]:
        ...
        return self.get_outputs(ray_bundle, lidar_rays=lidar_rays, sky_mask=sky_mask)
